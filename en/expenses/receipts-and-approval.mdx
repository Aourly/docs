...
- For billable expenses, confirm the assignment link
...
<AccordionGroup>
  ...
  <Accordion title="How do expenses flow into invoices?">
    Billable expenses that are Handled and linked to an assignment become available as line items when you create an invoice for that assignment. The expense amount plus any margin is added to the invoice. Once the invoice is sent and paid, the expense is marked as Paid.
  </Accordion>
</AccordionGroup>
