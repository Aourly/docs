...
**Characteristics:**
- Not linked to a specific assignment (optional linking for cost tracking)
...
1. The assignment has a **general markup percentage** (e.g., 10%)
...
- The assignment has a 10% markup
- The margin is 800 SEK
- The client is invoiced 8,800 SEK

### Setting the Markup

The markup percentage is set on the assignment, not on individual expenses. This ensures consistency across all billable expenses for that project. To change it:
...
- **Agree upfront**: Discuss the markup with your client before starting work. Include it in the assignment terms.
- **Be reasonable**: Standard markups for Swedish freelancers range from 5% to 15%.
- **Document it**: The approved assignment snapshot includes the markup percentage, so both parties have a record of the agreed terms.
...
1. Only handled billable expenses linked to the assignment are available
...
<AccordionGroup>
  ...
  <Accordion title="Can a non-billable expense be linked to an assignment?">
    Yes. Even though the expense will not be invoiced to the client, linking it to an assignment helps you track the total cost of a project, including costs you absorbed.
  </Accordion>
